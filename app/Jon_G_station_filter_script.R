...
if(!file.exists('www/hydat_daily_all.rds')){
  ...
  saveRDS(hydat_daily_all, file = 'www/hydat_daily_all.rds')
}

hydat_daily_all <- read_rds(file = "www/hydat_daily_all.rds")
...
write.csv(final_stations_summary, 'www/filtered_station_list.csv')
